///tmc_vec4_div_o(tmc_vec4,tmc_vec4,o_tmc_vec4)
/*
    divides the 2 vectors together WITHOUT returning a new vector
    o_tmc_vec4 serves as output parameter
    var o = tmc_vec4(10,10,10,10);
    tmc_vec4_dic_io(tmc_vec4(10,10,10,10),tmc_vec4(10,10,10,10),o);
